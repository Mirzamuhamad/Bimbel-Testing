          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="Text" id="CourseID" name="CourseID" class="form-control" autocomplete="off">
              </div>

              <div class="form-group">
                <label for="Course">Course Name</label>
                <input type="Text" id="Course" name="CourseName" class="form-control" autocomplete="off">
              </div>

              <div class="form-group">
                <label for="UrlImage">Url Image</label>
                <input type="Text" id="UrlImage" name="UrlImage" class="form-control" autocomplete="off">
              </div>
