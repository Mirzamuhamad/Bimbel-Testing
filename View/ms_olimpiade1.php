                                                        ...
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group">
                                                                        <div class="input-group date">
                                                                            <input type="text" id="test" name="test" required class="form-control datetimepicker" value="<?= date('d-m-Y', strtotime($Edit['ExamDateStart'])); ?>" />
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" id="test1" name="test1" class="form-control datetimepicker" />
                                                                    </div>
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date" id="reservationdate3" data-target-input="nearest">
                                                                            <input type="Text" id="ExamDateStart" name="ExamDateStart" required class="form-control datetimepicker" data-target="#reservationdate3" value="<?= date('d-m-Y', strtotime($Edit['ExamDateStart'])); ?>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                                                            <input type="Text" id="ExamDateEnd" name="ExamDateEnd" required class="form-control" data-target="#reservationdate4" value="<?= date('d-m-Y', strtotime($Edit['ExamDateEnd'])); ?>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date" id="reservationdate5" data-target-input="nearest">
                                                                            <input type="Text" id="RegistrationDate" name="RegistrationDate" required class="form-control" data-target="#reservationdate2" value="<?= date('d-m-Y', strtotime($Edit['RegistrationDate'])); ?>">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <div class="custom-file">
                                                                        <input id="UrlImage2" class="form-control custom-file-input" required type="file" name="gambar2" onchange="PreviewImageAdd();" />
